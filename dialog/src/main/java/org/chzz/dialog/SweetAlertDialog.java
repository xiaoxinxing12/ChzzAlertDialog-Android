...
public class SweetAlertDialog extends Dialog implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView = (ListView) findViewById(R.id.lv_text);
    ...
    public SweetAlertDialog setListView(List<Map<String, Object>> item) {
        listItems = item;
        SimpleAdapter simplead = new SimpleAdapter(getContext(), item,
                R.layout.simple_item, new String[]{"name"},
    ...
    public SweetAlertDialog setListItemClickListener(OnListItemClickListener listener) {
